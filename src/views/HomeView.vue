<template>
    ...
    <div class="md:flex flex-row">
      <div class="basis-50	mt-10  p-20">
        ...
        <div class="pt-9">
          ...
          <br>
          <p class="text-secondary">Distinctively re-engineer revolutionary meta-services and premium architectures.
            Intrinsically
            incubate.
          </p>
        ...
        <span class="mt-6   flex items-center ">
          <div class="p-4 flex items-center  rounded text-primary bg-white "> Explore Property <svg
              class="w-4 ml-4 bg-amber-500	 rounded-full py-1 px-1" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512">
              <path fill="white"
  ...
  <div class="m-6 p-3 ">
    ...
    <a href="#"
      ...
      <div class="p-12 ">
        ...
        <span class="text-base font-semibold text-primary"> PROPERLAND INTRO</span>

        <h2 class="text-2xl pt-4 text-primary font-bold">Buying & Selling Property
          In An Easy Way</h2>
        <p class="text-secondary pt-2">Distinctively re-engineer revolutionary meta-services and premium At vero eos et
        ...
        <span class="md:flex ">
          <span class="basis-1/3 flex text-center  p-1 ">
            <svg fill="gray" class="w-6 mr-2 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-352a96 96 0 1 1 0 192 96 96 0 1 1 0-192z" />
            </svg>Only pay when you publish
          </span>
      ...
      <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-64 md:rounded-none md:rounded-s-lg"
        src="../assets/media/Photo.jpg" alt="">
  ...
  <div class="relative py-12 mt-12 bg-[#F5F1EF] z-[1]">
    ...
    <div class="relative z-[1]">
      <div class="md:flex flex-wrap m-3">
        <div v-for="(item, index) in pic" :key="index" class="md:w-1/2 p-2">
          <Card :src="item.img" :title="item.title" class="basic-50"></Card>
        </div>
...
you find the right Propertys" text="About Us" number="04"></TitleSection>
        ...
        <div>
          <button class="  bg-amber-400 text-primary p-3 text-sm rounded">Learn More</button>
      ...
      <span class="basic-50">
        <img class="h-full" src="../assets/media/labtop.png" alt="">
...
const pic = ref([
  ...
  { img: '../assets/media/4.png', title: 'Home in Downtown, Los Angeles' },
  { img: '../assets/media/5.png', title: 'Comefortable Appartment' },
  { img: '../assets/media/Image2.png', title: 'Home in Downtown, Los Angeles' },
  { img: '../assets/media/6.png', title: 'Comefortable Appartment' },
  { img: '../assets/media/6.png', title: 'Home in Downtown, Los Angeles' },

<template>
  ...
  <div
    class="flex m-2 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md"
  >
    <div
    ...
    <div class="p-6">
      <div class="flex items-center justify-between">
        ...
        <button class="btn bg-amber-400 text-white p-1 text-sm rounded">
          For Sale
        </button>
      </div>
      <p
        class="block font-bold mt-3 font-sans text-xl antialiased leading-relaxed text-gray-700"
      >
        {{ title }}
      </p>
    ...
    <div class="flex items-center justify-between m-4">
      <p
        class="block font-sans rounded border border-slate-200 p-1 flex text-sm antialiased font-normal"
      >
        <svg
          class="w-5 mr-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <p
        class="block font-sans rounded border border-gray-200 m-1 p-1 flex text-sm antialiased font-normal"
      >
        <svg
          class="w-5 mr-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <p
        class="block font-sans rounded border border-gray-200 p-1 flex text-sm antialiased font-normal"
      >
        <svg
          class="w-5 mr-2"
          xmlns="http://www.w3.org/2000/svg"
